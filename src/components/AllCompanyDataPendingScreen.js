...
export default AllCompanyDataPendingScreen = ({ route, navigation }) => {
    ...
    return companyReducer.allCompanyPendingArr !== [] ? (
        <View style={[styles.container, CommonStyles.screenPadding]}>
            ...
            <FlatList
                ...
                data={companyReducer.allCompanyPendingArr}
                    ...
                    return (
                        <View style={styles.tasksMainContainer} key={index}>
                            <View style={styles.taskDateAndDayContainer}>
                                <Image
                                    style={styles.radioBTNbig}
                                    source={IconLinks.radioButtonUnselected
                                    }
                                />
                                <View style={styles.dateAndDayContainer}>
                                    <Text style={styles.dateAndDayTxt}>
                                        {dateInFormat(item.dailyTaskName)}
                                    </Text>
                                    <Text style={styles.dateAndDayTxt}>
                                        {daysOfWeek[dateObj.getDay(item.createdAt)]}
                                    </Text>
                                </View>
                            </View>
                                            ...
                                            <View style={styles.tasksSubContainer}>
                                                <View
                                                    ...
                                                    <View>
                                                        <Text
                                                            style={{
                                                                fontSize: fontSizeChart._10px,
                                                                color: COLORS.orange,
                                                                marginBottom: 6, fontFamily: 'Montserrat-Medium',
                                                            }}>
                                                            {note.companyName}
                                                        </Text>
                                                    </View>
                                                                                ...
                                                                                <View
                                                                                    ...
                                                                                    <TouchableOpacity
                                                                                        ...
                                                                                        <Image
                                                                                            source={
                                                                                                task.isPending
                                                                                                    ? IconLinks.radioButtonUnselected
                                                                                                    : IconLinks.radioButtonSelected
                                                                                            }
                                                                                            style={styles.radioBTNsmall}
                                                                                        />
                                                                                    </TouchableOpacity>
                                                                                    <Text
                                                                                        style={[
