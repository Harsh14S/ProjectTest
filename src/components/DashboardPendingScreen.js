...
import { currentCompanyData, pendingCompanyData, setCompanyDataFromAsync, updatePendingStatus } from '../redux/reducers/Reducer'

const dateObj = new Date();
const daysOfWeek = ['Sun', 'Mon', 'Tue', 'Wed', 'Thur', 'Fri', 'Sat'];

export default DashboardPendingScreen = ({ route, navigation }) => {
  ...
  return currentCompanyDataIndex !== null && companyData ?
    <View style={[styles.container, CommonStyles.screenPadding]}>
      ...
      <FlatList
        ...
        data={companyReducer.currentCompanyPendingArr[0]?.dailyTaskData}
